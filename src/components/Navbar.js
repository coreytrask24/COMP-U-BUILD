...
const history= useHistory();
    ...
    window.addEventListener('resize', showButton);
        ...
        <div className="navbar--container width">
            ...
            <img src="images/CUB_logo_primary.svg" width="200"
         />
            </Link>
            ...
            <li className='nav-item'>
                <Link to="/forum" className='nav-links hvr-underline-from-center' onClick={closeMobileMenu}>
                    Forum
                </Link>
            </li>
            <li className='nav-item'>
            ...
            <li className='nav-item'>
                <Link to="/buildguide" className='nav-links hvr-underline-from-center' onClick={closeMobileMenu}>
                   Build Guides
                </Link>
            </li>
