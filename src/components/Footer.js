        ...
        <div className='footer-container'>
            <section className="footer-subscription">
                <p className="footer-subscription-heading">
                    Join the weekly newsletter to recieve up to date information on all things related to computer builds and computer parts.
                </p>
                    ...
                    <section className="social-media">
                       <div className="social-media-wrap">
                           <div className="footer-logo">
                               ...
                               <img src="images/CUB_logo.svg" width="40"
         />
                               </a>
                           </div>
                           <small className="website-rights">COMP-U-BUILD 2021</small>
